	 ...
	 */
		 ...
		 * 	5. Place the MASTER TAG near the RFID reader. 
		 * 	6. Enter the MASTER CODE into the keypad. 
		 */
		...
		if(readKeyCode())
		{
			...
			if(KeyCodeKeyStore.keyIsValid(KeyCode, &key_data))
			{
				...
				if(key_data.master)
				{
					...
					//while(!readKeyCode() || keyIsEqual(master_keycode, KeyCode, KEYCODE_KEY_SIZE))
					//	;
